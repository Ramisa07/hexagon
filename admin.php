...
<body>
   ...
   <header id="top">
   	...
   	<div class="row">
		   ...
		   <h1 id="logo-text"><a href="index.php" title="">HEXAGON</a></h1>
		   <p id="intro">A blogging Site for Everyone</p>
	   ...
	   <nav id="nav-wrap"> 
	   	...
	   	<div class="row">    		            
			   	...
			   	<ul id="nav" class="nav">
					  ...
					  <li class="nav-item">
          <a class="nav-link" href="admin.php">Writing</a>
        </li>   	
   ...
   <div id="content-wrap">
     ...
     ?>
				...
				<div class="widget widget_text group">
   				...
   				<p>Kafka on the Shore</p><br/>
				<p>“All of a sudden the air feels thin and something heavy is bearing down on my chest. Am I really doing the right thing? The thought makes me feel helpless, isolated.”― Haruki Murakami</p>
   ...
   <footer>
	  ...
	  <p class="copyright">&copy;ramisanoushinsohely. &nbsp; Design by <a title="Styleshout" href="/">Homies</a>.</p>
